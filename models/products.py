    ...
    def read(id=None):
        ...
        with sqlite3.connect(PATH_TO_DB) as connection:
            ...
            if id!=None:
                ...
                single_product = __class__(product_id=result[0],product_name=result[1], quantity=result[2],  price=result[3],category=result[4])
                ...
                for result in results:
                    product = __class__(product_id=result[0],product_name=result[1], quantity=result[2],  price=result[3],category=result[4])
